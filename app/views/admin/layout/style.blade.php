 <link rel="stylesheet" href="{{ BASE_URL. 'public/admin/dist/css/index.css'}}">
  <!-- boostrap link -->
  ...
  <!-- Favicon icon -->
  <link rel="icon" type="{{ BASE_URL. 'public/admin/dist/img/logo2.png'}}" sizes="16x16" href="{{ BASE_URL. 'public/admin/dist/img/logo2.png'}}">
