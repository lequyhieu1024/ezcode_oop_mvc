        ...
        <tbody>
            ...
            foreach ($course as $row) :
                ...
                <tr>
                    ...
                    <td><a href="index.php?url=edit-course&id=<?= $id_khoa_hoc; ?>"><button style="margin-bottom: 10px;" class="btn btn-warning">Sửa</button></a>
                        <a href="index.php?url=delete-course&id=<?= $id_khoa_hoc; ?>"><button style="margin-bottom: 10px;" class="btn btn-danger">Xóa</button></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
