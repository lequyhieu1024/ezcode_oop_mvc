            ...
            <div class="container pl-0 pr-0">
                <div class="nav-content">
                    ...
                    <ul class="mb-3">
                        ...
                        <li><a href="login" class="nav-content-bttn open-font h-auto pt-2 pb-2"><i style="color:green" class="font-sm feather-log-in mr-3 text-green-500"></i><span>Đăng nhập</span></a>
                            <a href="register" class="nav-content-bttn open-font h-auto pt-2 pb-2"><i style="color:blue" class="font-sm feather-user-plus mr-3 text-blue-500"></i><span>Đăng ký</span></a>
                        </li>
                    <?php }
                    ?>
                ...
                <ul class="d-flex ml-auto right-menu-icon">
                    ...
                    if (isset($_SESSION['ten_tai_khoan'])) {
                        foreach ($info as $tt) : extract($tt); ?>
                            <li><a href="<?= BASE_URL ?> myinfo"><img src="<?= PATH_IMG . $avt ?>" alt="user" class="w40 mt--1"></a></li>
                        <?php endforeach ?>
