...
<body>
    <div class="tttt">
        ...
        <form method="POST" id="paymentForm" enctype="application/x-www-form-urlencoded" class="form-group">
            <div class="thongtinthanhtoan">
                ...
                <div class="thongtindonhang">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <td>Khóa học</td>
                            <td name="ten_khoa_hoc"><?= $ttkh['ten_khoa_hoc'] ?></td>
                        </tr>
                        <tr>
                            <td>Tiền học</td>
                            <td>$ <?= number_format($ttkh['tien_hoc'], 0, ".", ",") ?></td>
                        </tr>
                        <tr>
                            <td>Lộ trình</td>
                            <td>
    ...
    <script>
        ...
        function preparePayment() {
            ...
            if (paymentMethod === '1') {
                ...
                document.getElementById('paymentForm').action = '?url=pay';
            } else {
