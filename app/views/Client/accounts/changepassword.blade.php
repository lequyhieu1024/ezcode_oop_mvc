                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                <div class="form-gorup">
                                    ...
                                    <input type="text" name="mat_khau_old" placeholder="mật khẩu cũ" class="form-control">
                                </div>        
                            </div>
                            ...
                            <div class="col-lg-12 mb-3">
                                <div class="form-gorup">
                                    ...
                                    <input type="text" name="mat_khau_new" placeholder="mật khẩu mới" class="form-control">
                                </div>        
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                <div class="form-gorup">
                                    ...
                                    <input type="text" name="xn_mat_khau" placeholder="xác nhận mật khẩu" class="form-control">
                                </div>        
                            </div>                                     
                        </div>
                        <div class="row">
                            <div class="col-lg-12 mb-0">
                                <button type="submit" name="changepassword" class="bg-current text-center text-white font-xsss fw-600 p-3 w175 rounded-lg d-inline-block">Cập nhật</button>
                            </div>
                        </div>
                        </form>
                </div>
